...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    class HDPathTracer
    {
        ...
        public void Render(HDCamera hdCamera, CommandBuffer cmd, RTHandle outputTexture, ScriptableRenderContext renderContext, int frameCount)
        {
            ...
            bool invalidState = rtEnvironment == null || !pathTracingSettings.enable.value || pathTracingShader == null
                || m_PipelineResources.textures.owenScrambled256Tex == null || m_PipelineResources.textures.scramblingTex == null;
            ...
            RTHandle history = hdCamera.GetCurrentFrameRT((int)HDCameraFrameHistoryType.RaytracedReflection)
